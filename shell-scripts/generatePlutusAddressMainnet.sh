...
#mainnet: zsh generatePlutusAddress.sh paasV2  paasV2Mainnet
$CARDANO_CLI address build --payment-script-file ../generated-plutus-scripts/paasV1/${SCRIPTNAME}.plutus --mainnet --out-file ../wallets/${ADDRESS}.addr