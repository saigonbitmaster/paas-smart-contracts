#!/bin/zsh
#zsh payToScriptV2AutoSeletUtxo valueInLovelace scriptName datumJsonFile walletName
#zsh payToScriptV2AutoSeletUtxo.sh  3000000 paasV2 secret.json wallet01
...
PAYMENT=${1}
SCRIPT_ADDRESS=$($CARDANO_CLI address build --payment-script-file ../generated-plutus-scripts/paasV1/$2.plutus --testnet-magic $TESTNET_MAGIC_NUM)
DATUM_FILE=${3}
