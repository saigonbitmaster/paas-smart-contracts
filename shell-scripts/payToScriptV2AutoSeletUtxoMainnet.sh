...
#zsh payToScriptV2AutoSeletUtxoMainnet.sh  3100000 paasV2 secretMainnet.json wallet01Mainnet
...
VALUE_TO_LOCK=${1}
SCRIPT_NAME=${2}
SCRIPT_ADDRESS=$(${CARDANO_CLI} address build --payment-script-file ../generated-plutus-scripts/paasV1/${SCRIPT_NAME}.plutus --mainnet)
DATUM_FILE=${3}
