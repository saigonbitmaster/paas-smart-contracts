#!/bin/bash
# Usage:
# $ ./burn-token-testnet.sh $tokenName $payment_address $policy_directory_path $tokenamount $txHash
#
# For eg:
# $ ./burn-token-testnet.sh paas `cat payment1.addr` paas-policy 5000 d448e8722cba3abbdfa994ee4cfc6318ebad0e307bb535214979d11bea8bee22
