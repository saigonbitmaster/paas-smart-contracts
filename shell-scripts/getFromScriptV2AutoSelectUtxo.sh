#!/bin/zsh
#this script is similar to getFromScriptV2 except it calls different functions from utils.sh 
#to auto select collatel & curent locked utxo (the utxo need to be unlocked)
#zsh getFromScriptV2AutoSelectUtxo.sh scriptName redeemerJsonFile payCollatelWalletName receiveWalletAddress scriptTxHash
#zsh getFromScriptV2AutoSelectUtxo.sh paasV2 secret.json wallet01 addr_test1vz52h0cn9ua9vl8ak4yz4czas3sf3ftjy82a5tt7ladhufqyuk45c 6e767bbbff2b90e163ae4f1225b563bc11fd33642c3c43c7aca55f90a7bd5cdd 

source ./utils.sh

SCRIPT_NAME=${1}
SCRIPT_FILE=../generated-plutus-scripts/paasV1/${SCRIPT_NAME}.plutus
